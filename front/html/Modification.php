        ...
        <div id="Register_Container" class="row card horizontal">
            <form class="col s12">
                <div class="row">
                    ...
                    <div class="input-field col s6">
                        <input id="last_name" type="text" class="validate" value="<?php echo $_SESSION['monUserCo']['nom'] ?>">
                        <label for="last_name"><i class="tiny material-icons">mode_edit</i> Nom</label>
                    </div>
                </div>
                <div class="row">
                    <div class="input-field col s12">
                        <input id="password" type="password" class="validate" value="<?php echo $_SESSION['monUserCo']['password'] ?>">
                        <label for="password"><i class="tiny material-icons">lock</i> Mot de passe</label>
                    </div>
                </div>
                <div class="row">
                    <div class="input-field col s12">
                        <input id="email" type="email" class="validate" value="<?php echo $_SESSION['monUserCo']['mail'] ?>">
                        <label for="email"><i class="tiny material-icons">email</i> Email</label>
                    </div>
                </div>
                <div class="row">
                    <div class="input-field col s12">
                        <input id="telephone" type="text" class="validate" value="<?php echo $_SESSION['monUserCo']['numeroTelephone'] ?>">
                        <label for="telephone"><i class="tiny material-icons">phone</i> T&eacutel&eacutephone</label>
                    </div>
                </div>
                <div class="row">
                    <div class="input-field col s12">
                        <input id="datepicker_register" type="date" class="validate" placeholder="Date de naissance" value="<?php echo $_SESSION['monUserCo']['dateNaissance'] ?>">
                    </div>
                </div>
