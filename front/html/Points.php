<?php $title = "Comment gagner des points";include '../../fragments/header.php';?>
<html>
	<head>
	...
	<body><
		<div class="transparence">
			<div id="Register_Container" class="row card horizontal">
				...
				<p>
					Pour gagner des points sur le site web, il faudra effectuer certaines actions que nous allons vous décrire ci-dessous : 
				</p>
				<ul class="collection">
				...
				Le fait d'utiliser la gammification permet à chacun de se challenger. </p>
				</br>
					</div>
					</div>
			</body>
